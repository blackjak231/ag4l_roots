		...
		<form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<p>
						<label for="bbp_forum_title"><?php printf( __( 'Nom du Forum (Caractère max: %d):', 'bbpress' ), bbp_get_title_max_length() ); ?></label><br />
...
<?php else : ?>
	...
	<div id="no-forum-<?php bbp_forum_id(); ?>" class="bbp-no-forum">
		<div class="bbp-template-notice">
			<p><?php is_user_logged_in() ? _e( 'Vous ne pouvez pas créer de forum.', 'bbpress' ) : _e( 'Vous devez vous connecter pour créer un forum.', 'bbpress' ); ?></p>
		</div>
	</div>
