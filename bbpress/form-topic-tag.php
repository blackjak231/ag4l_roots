			...
			<fieldset class="bbp-form" id="tag-rename">
				...
				<form id="rename_tag" name="rename_tag" method="post" action="<?php the_permalink(); ?>">
					...
					<div>
						...
						<input type="text" id="tag-name" name="Nom du tag" size="20" maxlength="40" tabindex="<?php bbp_tab_index(); ?>" value="<?php echo esc_attr( bbp_get_topic_tag_name() ); ?>" />
					</div>
			...
			<fieldset class="bbp-form" id="tag-merge">
				...
				<form id="merge_tag" name="merge_tag" method="post" action="<?php the_permalink(); ?>">
					...
					<div>
						...
						<input type="text" id="tag-existing-name" name="Nom de tag existant" size="22" tabindex="<?php bbp_tab_index(); ?>" maxlength="40" />
					</div>
